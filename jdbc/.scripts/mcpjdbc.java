...
class jdbc implements Callable<Integer> {
    ...
    String getMcpServerAlias() {
        ...
        if (mcpServer == null) { // use earlyaccess version by default for now.
            ...
            mcpServer = "https://github.com/mudigondas125/quarkus-mcp-servers/releases/download/early-access/mcp-server-jdbc.jar";
        }
        return mcpServer;
    }
    ...
    private Map<String, List<String>> setupDrivers() {
        ...
        drivers.put("db2", List.of("com.ibm.db2:jcc:12.1.0.0", "com.ibm.db2:jcc:RELEASE", "com.ibm.db2:jcc:11.5.8.0"));
